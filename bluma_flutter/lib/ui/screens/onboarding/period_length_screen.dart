  ...
  Future<void> _handleNext() async {
    try {
      if (!_dontKnow) {
        ...
        await repo.saveSetting('userPeriodLength', _periodLength.toString());
      }
      if (mounted) context.push('/onboarding/cycle-length');
    } catch (e) {
      if (mounted) context.push('/onboarding/cycle-length');
    }
  }
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'onboarding.periodLength.title'.tr(),
                  ...
                  DayPicker(
                    ...
                    max: 10,
                    disabled: _dontKnow,
                    onChange: (val) => setState(() => _periodLength = val),
                  ),
                  ...
                  Center(
                    child: CustomCheckbox(
                      ...
                      text: 'onboarding.periodLength.checkboxText'.tr(),
                      subText: 'onboarding.periodLength.checkboxSubtext'.tr(),
                    ),
                  ),
                ],
              ),
